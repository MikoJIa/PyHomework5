...
profitability = (profit / revenue * 100) / 100
profit_staff = profit / staff
print(f'Финансовый результат прибыли - {profit} ')
print(f'Рентабельность выручки - {profitability}')
print(f'Численность сотрудников {staff}, прибыл в расчёте на одного сотрудника - {profit_staff} ')